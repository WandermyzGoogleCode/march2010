...
\begin{abstract}
	...
	This paper presents a novel mechanism to frustrate such attack attempts. 
	This novel mechanism adopts an updatable piece of hardware 
	obfuscator to the encryption schema.
	The adoption of this obfuscator will add an extra layer of security 
	to the method of deterministic encyption.
