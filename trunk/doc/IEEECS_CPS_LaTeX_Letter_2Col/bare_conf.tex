...
\section{Analysis of Conditional Entropy}\label{sec_proof}
    ...
    \subsection{Definition and Example}
        ...
        \begin{align*}
            ...
            &\forall y \in \mathcal Y^{(1)}, \; p(Y^{(1)} = y) = \frac{1}{n}\\
            &p(x|y) = \begin{cases}
                \frac{1}{n-1}, &y \neq z^*\\
        ...
        \begin{mydef}[Defender Mechanism]
            ...
            \end{align*}
            and the attacker can track $\varepsilon_{-(i+1)}(P_{-i, j})$ and
            \begin{align*}
        ...
        subset of $C_{-i}$ that is enumerated by the attacker. In detail:
        \begin{mydef}[Candidate and Collision Set]
            ...
            \begin{equation*}
                K_{-i} = \{z | \varepsilon_{-i}(x) = z \text{ is enumerated by attacker and } z \in C_{-i} \}
            \end{equation*}
        \end{mydef}
    ...
    \subsection{Proof of a Lower Bound}
        ...
        \begin{align*}
            H(X|Y_r = \alpha) \geq r \cdot (1-\frac{r m \cdot 2^r}{2^E-2^r+1})
        \end{align*}
        \end{mylemma}
        ...
        \begin{IEEEproof}
            ...
            has been enumerated using $\varepsilon_0, \varepsilon_{-1}, \ldots, \varepsilon_{-(d-1)}$
...
%
        ...
        far away from the experimental result. By the more tight $p_1 \cdot p_2 \cdot p_3$
        conducted by the experiment, the lower bound is greater than $10$
        when $m = 2^{14} = 16384$.
