...
\author{\IEEEauthorblockN{Yuqian Li\IEEEauthorrefmark{1}, Yang Liu\IEEEauthorrefmark{1},
Zhifang Liu\IEEEauthorrefmark{1}, Jiwei Huang\IEEEauthorrefmark{1}, Zhen Chen\IEEEauthorrefmark{2}}
\IEEEauthorblockA{Department of Computer Science and Technology\\
Tsinghua University\\
Beijing 10084, China\\
\IEEEauthorrefmark{1}\{liyuqian79, lywander, chimneyliu, hjw217\}@gmail.com, \IEEEauthorrefmark{2}zhenchen@tsinghua.edu.cn}
%\and
...
\begin{abstract}
    ...
    This paper presents a novel mechanism
    to frustrate dictionary attacks
    by refreshing the encryption in an external "blackbox".
    The "blackbox" has a private key inside and even the person who
    designed and manufactured it could not track or reveal its
    input and output without knowing the private key.
    The major part of this paper is about the analysis
    of this novel mechanism.
    The use of conditional entropy in this paper both measures the power
    to defend the attack and proves the value and feasibility
    of this novel mechanism.
    ...
    By the proof, this mechanism can provide very reliable
    security for PII in online social networks (OSN) and keep efficiency
...
\section{Defender Model and Mechanism}\label{sec_def}
    ...
    \subsection{Defender Mechanism}\label{sec_ds}
        ...
        like TPM, i.e. Trusted Platform Module) that nobody
